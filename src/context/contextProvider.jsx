...
const AppProvider = ({ children }) => {
    ...
    const fetch = async () => {
        const data = await productDetails("products/get-all")
        dispatch({ type: "SET_ALL_PRODUCTS", payload: data.content })
    ...
    return (
        <ContextProvider.Provider value={{
            state, dispatch, isProductCategory,setIsProductByCategories
        }}>
            {
                children
